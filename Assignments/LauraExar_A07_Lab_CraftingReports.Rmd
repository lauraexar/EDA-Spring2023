...
```{r echo=FALSE, fig.align='left', fig.cap="Ozone Levels by Month in 2018", fig.height=3, fig.width=5, warning=FALSE}
Ozone.2018 <- epa_data %>%
  filter(Year==2018) %>%
  ggplot(aes(
...
```{r echo=FALSE, fig.align='left', fig.cap="Ozone Levels by Month in 2019", fig.height=3, fig.width=5, warning=FALSE}
...
https://github.com/lauraexar/EDA-Spring2023 
