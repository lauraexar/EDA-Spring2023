...
-   R Markdowns can become *various outputs*, including:
    -   Document
    -   Presentation
    -   Shiny
-   An R Markdown document has:
    -   A YAML Header
    -   R Code Chunks
    -   Text
-   R Markdown documents can be **knitted**
...
#created and set my theme
my_theme <- theme_base() + theme(axis.line = element_line(linewidth=1, colour="black"),
...
#Imported the data
Lake.nutrients <- read.csv(file=here("Data/Raw/NTL-LTER_Lake_Nutrients_Raw.csv"), stringsAsFactors = TRUE)

#Set date columns to date objects
Lake.nutrients$sampledate <- mdy(Lake.nutrients$sampledate)
