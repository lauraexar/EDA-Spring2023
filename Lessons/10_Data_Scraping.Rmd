...
df_withdrawals <- data.frame("Month" = rep(1:12), #created a month
                             "Year" = rep(2000,12), #created a year
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant, #setting the variables
         Facility_name = !!the_facility_name,
         Facility_type = !!the_facility_type,
         Date = my(paste(Month,"-",Year))) #converting month and year objects to a date
